---
description: Keep a keel workspace's .keel/context.md in the shape the Keel Cockpit pane renders — fixed headings, one State line per project, Open questions as links, a bumped Updated date. Never write credentials or checkout paths into it.
mode: agent
---
